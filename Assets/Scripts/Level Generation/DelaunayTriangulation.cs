...
public class DelaunayTriangulation : MonoBehaviour
{
    ...
    public void RunDelaunayTriangulation(List<Node> NodeSet, Vector2 min, Vector2 max)
    {
    ...
    public void RunDelaunayTriangulation(List<Node> startingNodes, List<Node> NodeSet, Vector2 min, Vector2 max)
    {
        UnsortedNodes = NodeSet;
        Tri EncapTri = EncapsulateDomain(min, max);
