...
public static class HLGenerator
{
    ...
    private static void AddRoom(HLMap dungeonMap, HLAreaData roomData) {
        ...
        addingArea.SetPosition(dungeonMap.areas[connection.ToAreaIndex].GetRectCenter() + dungeonMap.areas[connection.ToAreaIndex].ConnectionPoints[connection.ToConnectionPoint].Position -
